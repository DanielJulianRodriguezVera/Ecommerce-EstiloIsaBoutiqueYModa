...
<div class="search-results">
    ...
    <table class="table">
        ...
        <tbody>
            ...
            if (isset($_GET['q'])) {
                ...
                $consulta = $conexion->query("SELECT * FROM administradores WHERE id_administrador LIKE '%$busqueda%' OR nombre LIKE '%$busqueda%' OR apellido LIKE '%$busqueda%' OR correo_electronico LIKE '%$busqueda%' OR contraseña LIKE '%$busqueda%'");
    ...
    <form id="searchForm" action="administradores.php" method="GET"></form>
    <script>
