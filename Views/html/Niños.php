...
<header class="header">
    ...
    <section class="busosNiños" id="busosNiños">
        <h1 class="heading"> Busos - <span>Camisetas</span> </h1>
        <div class="box-container">
            <?php
            $catalogoController->mostrarProductos("niños", "busos");
            ?>
        </div>
    </section>

    <section class="pantalonesNiños" id="pantalonesNiños">
        <h1 class="heading"><span>Pantalones</span> </h1>
        <div class="box-container">
            <?php
            $catalogoController->mostrarProductos("niños", "pantalones");
            ?>
        </div>
    </section>

    <section class="zapatosNiños" id="zapatosNiños">
        <h1 class="heading"> Zapatos <span>deportivos</span> </h1>
        <div class="box-container">
            <?php
            $catalogoController->mostrarProductos("niños", "zapatos");
            ?>
        </div>
    </section>
