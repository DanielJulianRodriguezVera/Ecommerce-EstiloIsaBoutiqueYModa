...
<header class="header">
    ...
    <section class="busos" id="busos">
        <h1 class="heading"> Busos - <span>Camisetas</span> </h1>
        <div class="box-container">
            <?php
            $catalogoController->mostrarProductos("hombres", "busos");
            ?>
        </div>
    </section>

    <section class="pantalonesHombre" id="pantalonesHombre">
        <h1 class="heading"><span>Pantalones</span> </h1>
        <div class="box-container">
            <?php
            $catalogoController->mostrarProductos("hombres", "pantalones");
            ?>
        </div>
    </section>

    <section class="zapatosHombre" id="zapatosHombre">
        <h1 class="heading"> Zapatos <span>deportivos</span> </h1>
        <div class="box-container">
            <?php
            $catalogoController->mostrarProductos("hombres", "zapatos");
            ?>
        </div>
    </section>
